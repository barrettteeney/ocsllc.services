(function () {
  var SQFT_TIERS = [
    ...
    },
    {
      ...
      screens: [
        { label: "No screens", value: 0 },
        { label: "1-29 screens", value: 15 },
        { label: "30-48 screens", value: 39 },
        { label: "49-72 screens", value: 60 }
      ]
    },
    {
      max: 8000,
      ...
      screens: [
        { label: "No screens", value: 0 },
        { label: "1-34 screens", value: 17 },
        { label: "35-56 screens", value: 45 },
        { label: "57-84 screens", value: 70 }
      ]
    }
  ];
  ...
  function makeWizard(form) {
    ...
    function canLeaveStep(index) {
      if (steps[index] && steps[index].title === "Home size") {
        if (isOversizeTierSelected(form) && getNumber(form, "sqft") <= 8000) {
          setError("Enter your best estimated square footage above 8,000 so Barrett has enough context.");
          return false;
        }
    ...
    if (form.elements.sqft) {
      form.elements.sqft.addEventListener("input", function () {
        if (isOversizeTierSelected(form)) {
          ...
          if (getNumber(form, "sqft") > 8000) applyTierDefaults(form, "6000plus");
          return;
        }
        form.elements.sqft.placeholder = "Example: 2200";
